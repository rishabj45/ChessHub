...
export function getProgressDisplay(tournament) {
    if (!tournament)
        return '';
...
export function getStageDescription(stage, format) {
...
export function getStageDisplayText(tournament) {
    if (!tournament)
        return '';
    if (tournament.stage === 'not_yet_started') {
        return 'Yet to start';
...
export function getFormatDisplayText(tournament) {
